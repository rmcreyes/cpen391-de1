// CPEN391_Computer_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module CPEN391_Computer_mm_interconnect_1 (
		...
		input  wire        IO_Bridge_reset_reset_bridge_in_reset_reset,                              //                              IO_Bridge_reset_reset_bridge_in_reset.reset
		output wire [3:0]  dot_0_slave_address,                                                      //                                                        dot_0_slave.address
		output wire        dot_0_slave_write,                                                        //                                                                   .write
		output wire        dot_0_slave_read,                                                         //                                                                   .read
		input  wire [31:0] dot_0_slave_readdata,                                                     //                                                                   .readdata
		output wire [31:0] dot_0_slave_writedata,                                                    //                                                                   .writedata
		input  wire        dot_0_slave_waitrequest,                                                  //                                                                   .waitrequest
	...
	wire   [20:0] io_bridge_avalon_slave_agent_m0_address;                       // IO_Bridge_avalon_slave_agent:m0_address -> IO_Bridge_avalon_slave_translator:uav_address
	...
	wire   [96:0] io_bridge_avalon_slave_agent_rf_source_data;                   // IO_Bridge_avalon_slave_agent:rf_source_data -> IO_Bridge_avalon_slave_agent_rsp_fifo:in_data
	...
	wire   [96:0] io_bridge_avalon_slave_agent_rsp_fifo_out_data;                // IO_Bridge_avalon_slave_agent_rsp_fifo:out_data -> IO_Bridge_avalon_slave_agent:rf_sink_data
	...
	wire   [31:0] dot_0_slave_agent_m0_readdata;                                 // dot_0_slave_translator:uav_readdata -> dot_0_slave_agent:m0_readdata
	wire          dot_0_slave_agent_m0_waitrequest;                              // dot_0_slave_translator:uav_waitrequest -> dot_0_slave_agent:m0_waitrequest
	wire          dot_0_slave_agent_m0_debugaccess;                              // dot_0_slave_agent:m0_debugaccess -> dot_0_slave_translator:uav_debugaccess
	wire   [20:0] dot_0_slave_agent_m0_address;                                  // dot_0_slave_agent:m0_address -> dot_0_slave_translator:uav_address
	wire    [3:0] dot_0_slave_agent_m0_byteenable;                               // dot_0_slave_agent:m0_byteenable -> dot_0_slave_translator:uav_byteenable
	wire          dot_0_slave_agent_m0_read;                                     // dot_0_slave_agent:m0_read -> dot_0_slave_translator:uav_read
	wire          dot_0_slave_agent_m0_readdatavalid;                            // dot_0_slave_translator:uav_readdatavalid -> dot_0_slave_agent:m0_readdatavalid
	wire          dot_0_slave_agent_m0_lock;                                     // dot_0_slave_agent:m0_lock -> dot_0_slave_translator:uav_lock
	wire   [31:0] dot_0_slave_agent_m0_writedata;                                // dot_0_slave_agent:m0_writedata -> dot_0_slave_translator:uav_writedata
	wire          dot_0_slave_agent_m0_write;                                    // dot_0_slave_agent:m0_write -> dot_0_slave_translator:uav_write
	wire    [2:0] dot_0_slave_agent_m0_burstcount;                               // dot_0_slave_agent:m0_burstcount -> dot_0_slave_translator:uav_burstcount
	wire          dot_0_slave_agent_rf_source_valid;                             // dot_0_slave_agent:rf_source_valid -> dot_0_slave_agent_rsp_fifo:in_valid
	wire  [114:0] dot_0_slave_agent_rf_source_data;                              // dot_0_slave_agent:rf_source_data -> dot_0_slave_agent_rsp_fifo:in_data
	wire          dot_0_slave_agent_rf_source_ready;                             // dot_0_slave_agent_rsp_fifo:in_ready -> dot_0_slave_agent:rf_source_ready
	wire          dot_0_slave_agent_rf_source_startofpacket;                     // dot_0_slave_agent:rf_source_startofpacket -> dot_0_slave_agent_rsp_fifo:in_startofpacket
	wire          dot_0_slave_agent_rf_source_endofpacket;                       // dot_0_slave_agent:rf_source_endofpacket -> dot_0_slave_agent_rsp_fifo:in_endofpacket
	wire          dot_0_slave_agent_rsp_fifo_out_valid;                          // dot_0_slave_agent_rsp_fifo:out_valid -> dot_0_slave_agent:rf_sink_valid
	wire  [114:0] dot_0_slave_agent_rsp_fifo_out_data;                           // dot_0_slave_agent_rsp_fifo:out_data -> dot_0_slave_agent:rf_sink_data
	wire          dot_0_slave_agent_rsp_fifo_out_ready;                          // dot_0_slave_agent:rf_sink_ready -> dot_0_slave_agent_rsp_fifo:out_ready
	wire          dot_0_slave_agent_rsp_fifo_out_startofpacket;                  // dot_0_slave_agent_rsp_fifo:out_startofpacket -> dot_0_slave_agent:rf_sink_startofpacket
	wire          dot_0_slave_agent_rsp_fifo_out_endofpacket;                    // dot_0_slave_agent_rsp_fifo:out_endofpacket -> dot_0_slave_agent:rf_sink_endofpacket
	wire          dot_0_slave_agent_rdata_fifo_src_valid;                        // dot_0_slave_agent:rdata_fifo_src_valid -> dot_0_slave_agent_rdata_fifo:in_valid
	wire   [33:0] dot_0_slave_agent_rdata_fifo_src_data;                         // dot_0_slave_agent:rdata_fifo_src_data -> dot_0_slave_agent_rdata_fifo:in_data
	wire          dot_0_slave_agent_rdata_fifo_src_ready;                        // dot_0_slave_agent_rdata_fifo:in_ready -> dot_0_slave_agent:rdata_fifo_src_ready
	...
	wire          io_bridge_avalon_slave_agent_rp_valid;                         // IO_Bridge_avalon_slave_agent:rp_valid -> router_002:sink_valid
	wire   [95:0] io_bridge_avalon_slave_agent_rp_data;                          // IO_Bridge_avalon_slave_agent:rp_data -> router_002:sink_data
	wire          io_bridge_avalon_slave_agent_rp_ready;                         // router_002:sink_ready -> IO_Bridge_avalon_slave_agent:rp_ready
	wire          io_bridge_avalon_slave_agent_rp_startofpacket;                 // IO_Bridge_avalon_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          io_bridge_avalon_slave_agent_rp_endofpacket;                   // IO_Bridge_avalon_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          dot_0_slave_agent_rp_valid;                                    // dot_0_slave_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] dot_0_slave_agent_rp_data;                                     // dot_0_slave_agent:rp_data -> router_004:sink_data
	wire          dot_0_slave_agent_rp_ready;                                    // router_004:sink_ready -> dot_0_slave_agent:rp_ready
	wire          dot_0_slave_agent_rp_startofpacket;                            // dot_0_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          dot_0_slave_agent_rp_endofpacket;                              // dot_0_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire   [95:0] io_bridge_avalon_slave_burst_adapter_source0_data;             // IO_Bridge_avalon_slave_burst_adapter:source0_data -> IO_Bridge_avalon_slave_agent:cp_data
	...
	wire    [2:0] io_bridge_avalon_slave_burst_adapter_source0_channel;          // IO_Bridge_avalon_slave_burst_adapter:source0_channel -> IO_Bridge_avalon_slave_agent:cp_channel
	...
	wire          cmd_mux_002_src_valid;                                         // cmd_mux_002:src_valid -> dot_0_slave_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                          // cmd_mux_002:src_data -> dot_0_slave_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                         // dot_0_slave_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                       // cmd_mux_002:src_channel -> dot_0_slave_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                 // cmd_mux_002:src_startofpacket -> dot_0_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                   // cmd_mux_002:src_endofpacket -> dot_0_slave_burst_adapter:sink0_endofpacket
	wire          dot_0_slave_burst_adapter_source0_valid;                       // dot_0_slave_burst_adapter:source0_valid -> dot_0_slave_agent:cp_valid
	wire  [113:0] dot_0_slave_burst_adapter_source0_data;                        // dot_0_slave_burst_adapter:source0_data -> dot_0_slave_agent:cp_data
	wire          dot_0_slave_burst_adapter_source0_ready;                       // dot_0_slave_agent:cp_ready -> dot_0_slave_burst_adapter:source0_ready
	wire    [2:0] dot_0_slave_burst_adapter_source0_channel;                     // dot_0_slave_burst_adapter:source0_channel -> dot_0_slave_agent:cp_channel
	wire          dot_0_slave_burst_adapter_source0_startofpacket;               // dot_0_slave_burst_adapter:source0_startofpacket -> dot_0_slave_agent:cp_startofpacket
	wire          dot_0_slave_burst_adapter_source0_endofpacket;                 // dot_0_slave_burst_adapter:source0_endofpacket -> dot_0_slave_agent:cp_endofpacket
	...
	wire          router_002_src_valid;                                          // router_002:src_valid -> IO_Bridge_avalon_slave_rsp_width_adapter:in_valid
	wire   [95:0] router_002_src_data;                                           // router_002:src_data -> IO_Bridge_avalon_slave_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                          // IO_Bridge_avalon_slave_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [2:0] router_002_src_channel;                                        // router_002:src_channel -> IO_Bridge_avalon_slave_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                  // router_002:src_startofpacket -> IO_Bridge_avalon_slave_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                    // router_002:src_endofpacket -> IO_Bridge_avalon_slave_rsp_width_adapter:in_endofpacket
	wire          io_bridge_avalon_slave_rsp_width_adapter_src_valid;            // IO_Bridge_avalon_slave_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [113:0] io_bridge_avalon_slave_rsp_width_adapter_src_data;             // IO_Bridge_avalon_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          io_bridge_avalon_slave_rsp_width_adapter_src_ready;            // rsp_demux:sink_ready -> IO_Bridge_avalon_slave_rsp_width_adapter:out_ready
	wire    [2:0] io_bridge_avalon_slave_rsp_width_adapter_src_channel;          // IO_Bridge_avalon_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          io_bridge_avalon_slave_rsp_width_adapter_src_startofpacket;    // IO_Bridge_avalon_slave_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          io_bridge_avalon_slave_rsp_width_adapter_src_endofpacket;      // IO_Bridge_avalon_slave_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                             // cmd_mux:src_valid -> IO_Bridge_avalon_slave_cmd_width_adapter:in_valid
	wire  [113:0] cmd_mux_src_data;                                              // cmd_mux:src_data -> IO_Bridge_avalon_slave_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                             // IO_Bridge_avalon_slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                           // cmd_mux:src_channel -> IO_Bridge_avalon_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                     // cmd_mux:src_startofpacket -> IO_Bridge_avalon_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                       // cmd_mux:src_endofpacket -> IO_Bridge_avalon_slave_cmd_width_adapter:in_endofpacket
	wire          io_bridge_avalon_slave_cmd_width_adapter_src_valid;            // IO_Bridge_avalon_slave_cmd_width_adapter:out_valid -> IO_Bridge_avalon_slave_burst_adapter:sink0_valid
	wire   [95:0] io_bridge_avalon_slave_cmd_width_adapter_src_data;             // IO_Bridge_avalon_slave_cmd_width_adapter:out_data -> IO_Bridge_avalon_slave_burst_adapter:sink0_data
	wire          io_bridge_avalon_slave_cmd_width_adapter_src_ready;            // IO_Bridge_avalon_slave_burst_adapter:sink0_ready -> IO_Bridge_avalon_slave_cmd_width_adapter:out_ready
	wire    [2:0] io_bridge_avalon_slave_cmd_width_adapter_src_channel;          // IO_Bridge_avalon_slave_cmd_width_adapter:out_channel -> IO_Bridge_avalon_slave_burst_adapter:sink0_channel
	wire          io_bridge_avalon_slave_cmd_width_adapter_src_startofpacket;    // IO_Bridge_avalon_slave_cmd_width_adapter:out_startofpacket -> IO_Bridge_avalon_slave_burst_adapter:sink0_startofpacket
	wire          io_bridge_avalon_slave_cmd_width_adapter_src_endofpacket;      // IO_Bridge_avalon_slave_cmd_width_adapter:out_endofpacket -> IO_Bridge_avalon_slave_burst_adapter:sink0_endofpacket
	...
	wire          io_bridge_avalon_slave_agent_rdata_fifo_out_valid;             // IO_Bridge_avalon_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [17:0] io_bridge_avalon_slave_agent_rdata_fifo_out_data;              // IO_Bridge_avalon_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          io_bridge_avalon_slave_agent_rdata_fifo_out_ready;             // avalon_st_adapter:in_0_ready -> IO_Bridge_avalon_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                                 // avalon_st_adapter:out_0_valid -> IO_Bridge_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_out_0_data;                                  // avalon_st_adapter:out_0_data -> IO_Bridge_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                 // IO_Bridge_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                 // avalon_st_adapter:out_0_error -> IO_Bridge_avalon_slave_agent:rdata_fifo_sink_error
	...
	wire          dot_0_slave_agent_rdata_fifo_out_valid;                        // dot_0_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] dot_0_slave_agent_rdata_fifo_out_data;                         // dot_0_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          dot_0_slave_agent_rdata_fifo_out_ready;                        // avalon_st_adapter_002:in_0_ready -> dot_0_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                             // avalon_st_adapter_002:out_0_valid -> dot_0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                              // avalon_st_adapter_002:out_0_data -> dot_0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                             // dot_0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                             // avalon_st_adapter_002:out_0_error -> dot_0_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (IO_Bridge_reset_reset_bridge_in_reset_reset),   //                    reset.reset
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) dot_0_slave_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (IO_Bridge_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (dot_0_slave_agent_m0_address),                // avalon_universal_slave_0.address
		.uav_burstcount         (dot_0_slave_agent_m0_burstcount),             //                         .burstcount
		.uav_read               (dot_0_slave_agent_m0_read),                   //                         .read
		.uav_write              (dot_0_slave_agent_m0_write),                  //                         .write
		.uav_waitrequest        (dot_0_slave_agent_m0_waitrequest),            //                         .waitrequest
		.uav_readdatavalid      (dot_0_slave_agent_m0_readdatavalid),          //                         .readdatavalid
		.uav_byteenable         (dot_0_slave_agent_m0_byteenable),             //                         .byteenable
		.uav_readdata           (dot_0_slave_agent_m0_readdata),               //                         .readdata
		.uav_writedata          (dot_0_slave_agent_m0_writedata),              //                         .writedata
		.uav_lock               (dot_0_slave_agent_m0_lock),                   //                         .lock
		.uav_debugaccess        (dot_0_slave_agent_m0_debugaccess),            //                         .debugaccess
		.av_address             (dot_0_slave_address),                         //      avalon_anti_slave_0.address
		.av_write               (dot_0_slave_write),                           //                         .write
		.av_read                (dot_0_slave_read),                            //                         .read
		.av_readdata            (dot_0_slave_readdata),                        //                         .readdata
		.av_writedata           (dot_0_slave_writedata),                       //                         .writedata
		.av_waitrequest         (dot_0_slave_waitrequest),                     //                         .waitrequest
		.av_begintransfer       (),                                            //              (terminated)
		.av_beginbursttransfer  (),                                            //              (terminated)
		.av_burstcount          (),                                            //              (terminated)
		.av_byteenable          (),                                            //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                                     //             clk.clk
		.reset                   (IO_Bridge_reset_reset_bridge_in_reset_reset),                //       clk_reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                          //             clk.clk
		.reset                   (IO_Bridge_reset_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (dot_0_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (dot_0_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (dot_0_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (dot_0_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (dot_0_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (dot_0_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (dot_0_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (dot_0_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (dot_0_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (dot_0_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (dot_0_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (dot_0_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (dot_0_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (dot_0_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (dot_0_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (dot_0_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (dot_0_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (dot_0_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (dot_0_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (dot_0_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (dot_0_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (dot_0_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (dot_0_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (dot_0_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (dot_0_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (dot_0_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (dot_0_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (dot_0_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (dot_0_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (dot_0_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (dot_0_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (dot_0_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),               //                .error
		.rdata_fifo_src_ready    (dot_0_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (dot_0_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (dot_0_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dot_0_slave_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                       //       clk.clk
		.reset             (IO_Bridge_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (dot_0_slave_agent_rf_source_data),             //        in.data
		.in_valid          (dot_0_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (dot_0_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (dot_0_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (dot_0_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (dot_0_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (dot_0_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (dot_0_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (dot_0_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (dot_0_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dot_0_slave_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (IO_Bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (dot_0_slave_agent_rdata_fifo_src_data),       //        in.data
		.in_valid          (dot_0_slave_agent_rdata_fifo_src_valid),      //          .valid
		.in_ready          (dot_0_slave_agent_rdata_fifo_src_ready),      //          .ready
		.out_data          (dot_0_slave_agent_rdata_fifo_out_data),       //       out.data
		.out_valid         (dot_0_slave_agent_rdata_fifo_out_valid),      //          .valid
		.out_ready         (dot_0_slave_agent_rdata_fifo_out_ready),      //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	CPEN391_Computer_mm_interconnect_1_router router (
	...
	CPEN391_Computer_mm_interconnect_1_router router_001 (
	...
	CPEN391_Computer_mm_interconnect_1_router_002 router_002 (
	...
	CPEN391_Computer_mm_interconnect_1_router_003 router_003 (
	...
	CPEN391_Computer_mm_interconnect_1_router_003 router_004 (
		.sink_ready         (dot_0_slave_agent_rp_ready),                  //      sink.ready
		.sink_valid         (dot_0_slave_agent_rp_valid),                  //          .valid
		.sink_data          (dot_0_slave_agent_rp_data),                   //          .data
		.sink_startofpacket (dot_0_slave_agent_rp_startofpacket),          //          .startofpacket
		.sink_endofpacket   (dot_0_slave_agent_rp_endofpacket),            //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (IO_Bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (IO_Bridge_reset_reset_bridge_in_reset_reset),                // cr0_reset.reset
		.sink0_valid           (io_bridge_avalon_slave_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (io_bridge_avalon_slave_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (io_bridge_avalon_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (io_bridge_avalon_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (io_bridge_avalon_slave_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (io_bridge_avalon_slave_cmd_width_adapter_src_ready),         //          .ready
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (dot_0_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (dot_0_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (dot_0_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (dot_0_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (dot_0_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (dot_0_slave_burst_adapter_source0_ready)          //          .ready
	);

	CPEN391_Computer_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (System_PLL_sys_clk_clk),                                                   //        clk.clk
		.reset              (ARM_A9_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	CPEN391_Computer_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (System_PLL_sys_clk_clk),                                                   //        clk.clk
		.reset              (ARM_A9_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	CPEN391_Computer_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset               (IO_Bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPEN391_Computer_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset               (IO_Bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPEN391_Computer_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset               (IO_Bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPEN391_Computer_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (System_PLL_sys_clk_clk),                                     //       clk.clk
		.reset              (IO_Bridge_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		.sink_ready         (io_bridge_avalon_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (io_bridge_avalon_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (io_bridge_avalon_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (io_bridge_avalon_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (io_bridge_avalon_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (io_bridge_avalon_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	CPEN391_Computer_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (IO_Bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPEN391_Computer_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (IO_Bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPEN391_Computer_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (System_PLL_sys_clk_clk),                                                   //       clk.clk
		.reset               (ARM_A9_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPEN391_Computer_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (System_PLL_sys_clk_clk),                                                   //       clk.clk
		.reset               (ARM_A9_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
	...
	) io_bridge_avalon_slave_rsp_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                     //       clk.clk
		.reset                (IO_Bridge_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		...
		.out_endofpacket      (io_bridge_avalon_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (io_bridge_avalon_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (io_bridge_avalon_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (io_bridge_avalon_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (io_bridge_avalon_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (io_bridge_avalon_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) io_bridge_avalon_slave_cmd_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                     //       clk.clk
		.reset                (IO_Bridge_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		...
		.out_endofpacket      (io_bridge_avalon_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (io_bridge_avalon_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (io_bridge_avalon_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (io_bridge_avalon_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (io_bridge_avalon_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (io_bridge_avalon_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                      // (terminated)
	);
	...
	CPEN391_Computer_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (IO_Bridge_reset_reset_bridge_in_reset_reset),       // in_rst_0.reset
	...
	CPEN391_Computer_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (IO_Bridge_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (dot_0_slave_agent_rdata_fifo_out_data),       //     in_0.data
		.in_0_valid     (dot_0_slave_agent_rdata_fifo_out_valid),      //         .valid
		.in_0_ready     (dot_0_slave_agent_rdata_fifo_out_ready),      //         .ready
